...
// import { UserDetailContext } from '../Provider';
// import { PreviewUpadtedContext } from '../../_context/PreviewUpdatedContext';

// function BasicDetail() {
//     let timeoutId;
//     const { user } = useUser();
//     const {updatePreview,setupdatePreview}=useContext(PreviewUpadtedContext)
        ...
        <div className="p-7 rounded-lg bg-gray-800 my-7">
            <div className="flex gap-6 items-center">
                <div className="relative">
                    ...
                    />
                    <CldUploadWidget
                        uploadPreset="portfolio-developer"
                        onSuccess={(result) => handleUploadSuccess(result)}
                    >
                        {({ open }) => (
                            <Camera
